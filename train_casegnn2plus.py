...
def forward(model, device, writer, dataloader, sumfact_pool_dataset, referissue_pool_dataset, label_dict, yf_path, epoch, temp, bm25_hard_neg_dict, hard_neg_num, pos_aug, ran_aug, aug_edgedrop, aug_featmask_node, aug_featmask_edge, train_flag, optimizer=None):
    if train_flag:
        ## Training
        model.train()
        optimizer.zero_grad()
